...
def m3u8_streams() -> list[Stream]:
    ...
    return [
        Stream(
            ...
            radio=False,
            tvg_id="daserste.de",
            group_titles="IPTV-DE",
            group_titles_kodi=["Vollprogramm"],
        ...
        Stream(
            group_titles="Radio-DE",
            group_titles_kodi=["Deutschland"],
...
def test_get_default_lines(line_writer: LineWriter, m3u8_streams: list[Stream]) -> None:
    ...
    expected = [
        ...
        [
            '#EXTINF:-1 tvg-name="ZDF" tvg-id="zdf.de" group-title="IPTV-DE" tvg-logo="https://example.com/logos/tv/zdf.png",ZDF',
            "https://zdf.m3u8",
        ],
        [
            '#EXTINF:-1 tvg-name="Deutschlandfunk" group-title="Radio-DE" radio="true" tvg-logo="https://example.com/logos/radio/deutschlandfunk.png",Deutschlandfunk',
...
def test_get_kodi_lines(line_writer: LineWriter, m3u8_streams: list[Stream]) -> None:
    ...
    expected = [
        ...
        [
            '#EXTINF:-1 tvg-name="ZDF" tvg-id="zdf.de" group-title="Vollprogramm" tvg-logo="https://example.com/logos/tv/zdf.png",ZDF',
            "https://zdf.m3u8",
        ],
        [
